...
namespace CharonX.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CharonXConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                ...
                new ApplicationLanguage(tenantId,"zh-CN","中文","famfamfam-flags cn")
            };
        }

        public DefaultLanguagesCreator(CharonXDbContext context)
        {
            _context = context;
        }
