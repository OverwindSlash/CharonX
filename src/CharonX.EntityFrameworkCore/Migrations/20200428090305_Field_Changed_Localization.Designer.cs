...
namespace CharonX.Migrations
{
    ...
    [Migration("20200428090305_Field_Changed_Localization")]
    partial class Field_Changed_Localization
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharonX.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CharonX.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CharonX.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CharonX.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CharonX.Authorization.Roles.Role", b =>
                {
                    b.HasOne("CharonX.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("CharonX.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("CharonX.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
